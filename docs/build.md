...
```basg
perator-sdk init --domain yaacov.com --repo github.com/yaacov/virt-gateway-operator
...
operator-sdk run bundle quay.io/yaacov/virt-gateway-operator-bundle:v0.0.1 \
