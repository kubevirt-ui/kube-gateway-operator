...
func (in *GateServerSpec) DeepCopyInto(out *GateServerSpec) {
	*out = *in
	if in.ServiceAccountVerbs != nil {
		in, out := &in.ServiceAccountVerbs, &out.ServiceAccountVerbs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ServiceAccountAPIGroups != nil {
		in, out := &in.ServiceAccountAPIGroups, &out.ServiceAccountAPIGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ServiceAccountResources != nil {
		in, out := &in.ServiceAccountResources, &out.ServiceAccountResources
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ServiceAccountResourceNames != nil {
		in, out := &in.ServiceAccountResourceNames, &out.ServiceAccountResourceNames
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ServiceAccountNonResourceURLs != nil {
		in, out := &in.ServiceAccountNonResourceURLs, &out.ServiceAccountNonResourceURLs
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
